				...
				<tr>
					...
					<td>
						...
						<?php foreach($taxonomies as $tax): ?>
							<label>
								<input type="checkbox" name="<?php echo $CGDArrangeTerms->get_field_name('enabled_taxonomies'); ?>[]" value="<?php echo $tax->name; ?>" <?php if ( in_array($tax->name, $CGDArrangeTerms->get_setting('enabled_taxonomies') ) ) echo 'checked="checked"'; ?> />	<?php echo $tax->labels->name; ?>
							</label><br/>
						<?php endforeach; ?>
