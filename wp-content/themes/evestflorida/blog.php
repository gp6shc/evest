	...
	<?php while ($wp_query->have_posts()) : $wp_query->the_post(); ?>
		...
		<div class="post" id="post-<?php the_ID(); ?>">
			<div class="title">
				...
				<div class="postmeta"> 	<span>Posted by <?php the_author_posts_link(); ?></span> | <span><?php the_time('l, F j, Y'); ?></span> | <span><?php the_category(', '); ?></span> </div>
			</div>
